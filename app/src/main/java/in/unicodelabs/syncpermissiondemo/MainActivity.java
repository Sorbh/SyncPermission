package in.unicodelabs.syncpermissiondemo;
...
import in.unicodelabs.sync_permission.SyncPermission;
import in.unicodelabs.sync_permission.interfaces.PermissionDeniedDelegate;
import in.unicodelabs.sync_permission.interfaces.PermissionRationalDelegate;
import in.unicodelabs.sync_permission.interfaces.PermissionResultCallback;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new SyncPermission.Builder(context).setPermissions(Manifest.permission.READ_CONTACTS).enqueue(new PermissionResultCallback() {
                    @Override
        ...
        locationBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new SyncPermission.Builder(context).setPermissions(Manifest.permission.ACCESS_FINE_LOCATION).enqueue(new PermissionResultCallback() {
                    @Override
                    public void onPermissionGranted(ArrayList<PermissionRequest> grantedPermission) {
                        for (PermissionRequest permissionRequest : grantedPermission) {
                            Log.d("Get Permission", "Granted - " + permissionRequest.getPermission());
